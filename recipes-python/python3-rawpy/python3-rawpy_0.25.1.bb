# Recipe adapted from meta-python-ai layer
# Original source: https://github.com/zboszor/meta-python-ai/blob/master/recipes-python/rawpy/python3-rawpy_0.25.1.bb
